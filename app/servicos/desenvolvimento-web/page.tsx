  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Presença Digital Eficiente</h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nossos Serviços de Desenvolvimento Web</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Websites Institucionais</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Portais e Sistemas Web</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Blogs e Portais de Conteúdo</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Manutenção e Atualização</h3>
              <p className="text-gray-500 mb-4">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Tecnologias que Utilizamos</h2>
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center justify-items-center">
            <div className="flex flex-col items-center justify-center p-4">
              <img alt="HTML5" className="h-16 w-auto mb-2" src="/placeholder.svg?height=64&width=64" />
              <span className="text-sm font-medium">HTML5</span>
            </div>
            <div className="flex flex-col items-center justify-center p-4">
              <img alt="CSS3" className="h-16 w-auto mb-2" src="/placeholder.svg?height=64&width=64" />
            ...
            <div className="flex flex-col items-center justify-center p-4">
              <img alt="WordPress" className="h-16 w-auto mb-2" src="/placeholder.svg?height=64&width=64" />
              <span className="text-sm font-medium">WordPress</span>
            </div>
            <div className="flex flex-col items-center justify-center p-4">
              <img alt="PHP" className="h-16 w-auto mb-2" src="/placeholder.svg?height=64&width=64" />
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nosso Processo de Desenvolvimento</h2>
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500">Definimos os objetivos, público-alvo e funcionalidades do seu website.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 mb-4">
              ...
              <p className="text-gray-500">Criamos wireframes e layouts que atendam às necessidades do seu negócio.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 mb-4">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Testes</h3>
              <p className="text-gray-500">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500">Publicamos seu website e fornecemos suporte contínuo após o lançamento.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Website ARN</h3>
            ...
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Portal UCB</h3>
                <p className="text-sm text-gray-500">Criação de portal educacional com área de alunos e professores.</p>
              </div>
            </div>
            <div className="group overflow-hidden rounded-lg border">
              <div className="relative aspect-video overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="font-bold">E-commerce Mercaducasa</h3>
                <p className="text-sm text-gray-500">
