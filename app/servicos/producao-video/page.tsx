  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Conteúdo Audiovisual de Impacto</h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nossos Serviços de Produção de Vídeo</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Vídeos Institucionais</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Vídeos Promocionais</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Vídeos para Redes Sociais</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Animação 2D e Motion Graphics</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Vídeos de Eventos</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Vídeos Educativos e Tutoriais</h3>
              <p className="text-gray-500 mb-4">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nosso Processo de Produção</h2>
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-500">Realizamos as filmagens ou criamos as animações conforme o planejamento.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 mb-4">
              ...
              <p className="text-gray-500">Montamos o vídeo, adicionamos efeitos, música e elementos gráficos.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 mb-4">
              ...
              <p className="text-gray-500">Realizamos ajustes finais e entregamos o vídeo nos formatos necessários.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Vídeo Institucional PNUD</h3>
            ...
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Spot Publicitário MTN</h3>
                <p className="text-sm text-gray-500">Criação de spot publicitário para campanha de marketing.</p>
              </div>
            </div>
            <div className="group overflow-hidden rounded-lg border">
              <div className="relative aspect-video overflow-hidden">
