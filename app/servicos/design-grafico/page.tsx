  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-blue-600 py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-white">Design Gráfico</h1>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Comunicação Visual Impactante</h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nossos Serviços de Design Gráfico</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Identidade Visual</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Material Impresso</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Design para Mídias Sociais</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Embalagens</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Sinalização</h3>
              <p className="text-gray-500 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-2">Ilustração</h3>
              <p className="text-gray-500 mb-4">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Nosso Processo de Design</h2>
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Criação</h3>
              <p className="text-gray-500">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Design Gráfico para PNUD</h3>
                <p className="text-sm text-gray-500">Criação de materiais visuais para campanha de conscientização.</p>
              </div>
            </div>
            <div className="group overflow-hidden rounded-lg border">
              <div className="relative aspect-video overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="font-bold">Identidade Visual MTN</h3>
            ...
            <div className="group overflow-hidden rounded-lg border">
              ...
              <div className="p-4">
                <h3 className="font-bold">Brochura UNICEF</h3>
                <p className="text-sm text-gray-500">
